...
const AFTER_SUBMIT_URL = "https://kinnusentahtirehut.fi/";
  ...
  document.body.innerHTML = `
    <div class="center">
      <div>
        ...
        <p style="font-size:14px;color:#6b7280;margin-top:6px">Ikkuna suljetaan tai ohjataan takaisin sivustolle.</p>
        <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap;margin-top:18px">
          <button class="nav secondary" type="button" onclick="closeWindowOrRedirect()">Sulje / palaa sivustolle</button>
        </div>
      </div>
    </div>`;
  setTimeout(closeWindowOrRedirect, 1800);
}
